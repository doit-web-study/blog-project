...
public interface PostControllerDocs {
    ...
    PostIdResponse writePost(PostCreateRequest postCreateRequest);

    @Operation(summary = "게시글 수정", description = "게시글을 수정한다.")
    @ApiResponse(responseCode = "200", description = "게시글 수정 성공")
    @ApiResponse(responseCode = "400", description = "게시글 수정 실패")
    PostIdResponse updatePost(Long postId, PostUpdateRequest postUpdateRequest);
    ...
    PostInfoWithUserInfoResponse getPost(Long postId);
}
